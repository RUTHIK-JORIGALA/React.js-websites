        ...
        <div className="experience-box">
            ...
            <div className='experience-text'>
                <p> <span> Nexonia Reporting</span>
                    <ul>
                        <li>Managed Nexonia reporting to ensure accurate and timely financial documentation.</li>
                    </ul>
                </p>
                <p> <span>LinkedIn Lead Generation </span>
                    <ul>
                        <li>Conducted lead generation on LinkedIn, identifying and engaging with potential clients.</li>
                    </ul>
                </p>
                <p> <span> Calendar Maintenance</span>
                    <ul>
                        <li>Efficiently maintained and organized calendars, scheduling appointments and meetings.</li>
                    </ul>
                </p>
                <p> <span>Podcast Research, Editing, and Content Creation </span>
                    <ul>
                        <li>Researched, edited, and created content for podcasts to enhance listener engagement.</li>
                    </ul>
                </p>
                <p> <span>Graphic Design </span>
                    <ul>
                        <li>Designed professional graphics for various marketing and promotional materials.</li>
                    </ul>
                </p>
                <p> <span> PowerPoint Presentations</span>
                    <ul>
                        <li>Developed and delivered impactful PowerPoint presentations for meetings and conferences.</li>
                    </ul>
                </p>
                <p> <span>Data Mining and Cleaning</span>
                    <ul>
                        <li>Performed data mining and cleaning to maintain database accuracy and integrity.</li>
                    </ul>
                </p>
                <p> <span>Converting PDF to Excel or PPT </span>
                    <ul>
                        <li>Converted PDFs to Excel or PowerPoint for improved data accessibility and presentation.</li>
                    </ul>
                </p>
                <p> <span>Preparing Employee Review Documents </span>
                    <ul>
                        <li>Prepared comprehensive employee review documents for performance evaluations.</li>
                    </ul>
                </p>
                <p> <span>Google Business Listing </span>
                    <ul>
                        <li>Managed Google Business listings to improve online presence and visibility.</li>
                    </ul>
                </p>
                <p> <span>Listing Emails for LinkedIn Connections </span>
                    <ul>
                        <li>Compiled and managed email lists for LinkedIn connections for targeted communication.</li>
                    </ul>
                </p>
                <p> <span> Scheduling Emails
                </span>
                    <ul>
                        <li>Scheduled emails to ensure timely and organized communication.</li>
                    </ul>
                </p>
                <p> <span>Excel Skills
                </span>
                    <ul>
                        <li>Utilized advanced Excel skills for data analysis and comprehensive reporting.</li>
                    </ul>
                </p>
                <p> <span> Market Research
                </span>
                    <ul>
                        <li>Conducted thorough market research to support strategic business decisions.</li>
                    </ul>
                </p>
                <p> <span>Email Account Management
                </span>
                    <ul>
                        <li>Managed email accounts to ensure efficient and organized communication.</li>
                    </ul>
                </p>
                <p> <span>Lead Generation
                </span>
                    <ul>
                        <li>Generated leads through effective marketing strategies.</li>
                    </ul>
                </p>
                <p> <span>Data Entry & Reporting
                </span>
                    <ul>
                        <li>Performed data entry and generated reports to support business operations.</li>
                    </ul>
                </p>
